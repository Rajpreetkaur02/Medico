...
import hospital_icon from "../assets/images/HospitalLogo.png";
...
//       $('NavbarHomeContainer').css('background-color', 'black');
//     });
//   }
    ...
    <div>
      <nav className="navbarHomeContainer">
        <div className="navbarHomeContainer1">
          <div className="navbarHomeContainer1pt2">
            ...
            <h1 className="webName">MediCo</h1>
          </div>
          ...
          <div className="navbarHomeSection2">
            ...
            <div className="navbarHomeSection2part3">
              ...
              <div>
                <Link to={"/Collections"}>BOOK APPOINTMENT</Link> 
              </div>
              <div cla>
              <Link to={"/"}>CONTACT</Link> 
              </div>
              <Link to={"/SignIn"}><button className = "heroContainerButton" onClick={""}>SIGN IN</button></Link> 
              {/* <button className = "heroContainerButton" onClick={""}>SIGN IN</button> */}
              {/* <div>
